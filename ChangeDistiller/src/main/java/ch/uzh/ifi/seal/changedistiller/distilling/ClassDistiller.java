...
public class ClassDistiller {
    ...
    private void processChanges(StructureDiffNode diffNode) {
        if (diffNode.isAddition()) {
            ...
            insert.setStructureEntityVersion(fRightASTHelper.createStructureEntityVersion(diffNode.getRight()));
            ...
            delete.setStructureEntityVersion(fLeftASTHelper.createStructureEntityVersion(diffNode.getLeft()));
    ...
    private void processBodyChanges(StructureDiffNode diffNode, StructureEntityVersion rootEntity) {
    	...
    	extractChanges(
    			rootEntity.getBodyLeft(),
    			rootEntity.getBodyRigth(),
                rootEntity);
    }
